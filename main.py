...
def main():
    ...
    options.add_argument("--headless")  # https://www.selenium.dev/blog/2023/headless-is-going-away/
    options.add_argument(f"user-agent={agent}")
    options.add_argument("window-size=1400,600")
    options.add_argument("log-level=3")
    options.add_experimental_option('excludeSwitches', ['enable-logging'])

    # Define o caminho para o arquivo chromedriver.exe
    chromedriver_path = os.path.join(os.path.dirname(__file__), "chromedriver.exe")

    # Define o caminho para o arquivo chromedriver.exe no PATH do sistema
